<template>
	<header ref="header">
		<div class="view">
			<img ref="imgbg1" src="https://static-cdn.wotgame.cn/dcont/fb/image/m54-1920h1080.jpg" style="display: none;">
			<div class="bg1" style="background-image: url('https://static-cdn.wotgame.cn/dcont/fb/image/m54-1920h1080.jpg');"></div>
			<div class="bg2" style="background-image: url('https://static-cdn.wotgame.cn/dcont/fb/image/1920x1080_burrasque_wallpaper.jpg');"></div>
			<div class="bg3" style="background-image: url('https://static-cdn.wotgame.cn/dcont/fb/image/lorraine_somua__1920x1080.png');" v-show="loaded"></div>
		</div>
		<div class="text-malfunction" data-word="坦 克 世 界">
			<div class="line"></div>
		</div>
		<div class="wrapper">
