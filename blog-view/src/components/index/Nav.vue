<template>
	<div ref="nav" class="ui fixed inverted stackable pointing menu"
		...
		<div class="ui container">
			...
			<!-- <el-dropdown trigger="click" @command="categoryRoute" class="">
			...
			<el-dropdown>
				...
				<el-dropdown-menu slot="dropdown">
					<el-dropdown-item icon="el-icon-plus">学习笔记</el-dropdown-item>
					<el-dropdown-item icon="el-icon-circle-plus">个人项目</el-dropdown-item>
					<el-dropdown-item icon="el-icon-circle-plus-outline">技术杂烩</el-dropdown-item>
					<el-dropdown-item icon="el-icon-check">心情随写</el-dropdown-item>
